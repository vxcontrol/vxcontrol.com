                            ...
                            <div className={'overflow-x-auto'}>
                                <table className={'w-full min-w-max'}>
                                    ...
                                    <tr className={'bg-panel'}>
                                        <td className={'pr-5 pl-5 pt-2.5 pb-2.5 text-lg text-hover border-main-dark border-r-2'}>{t('cookie_domain_vxcontrol')}</td>
                                    ...
                                    <tr>
                                        <td className={'pr-5 pl-5 pt-2.5 pb-2.5 text-lg text-hover'}>{t('cookie_domain_vxcontrol')}</td>
